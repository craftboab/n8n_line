...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='linebot_db'),
        'USER': config('DB_USER', default='linebot_user'),
        'PASSWORD': config('DB_PASSWORD', default='linebot_password'),
...
# n8n設定
N8N_WEBHOOK_URL = config('N8N_WEBHOOK_URL', default='http://localhost:5678/webhook/n8n')
